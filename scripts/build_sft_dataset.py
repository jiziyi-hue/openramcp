...
SYSTEM_PROMPT = (
    ...
    "由解释器查实时状态算坐标.\n"
    "force 筛选 (所有命令通用, kind=filter, owner=self): combat_mobile=true (全军-地面) | "
    "unit_kind=<1tnk轻坦/2tnk中坦/3tnk重坦/4tnk猛犸/ttnk特斯拉/ftrk防空车/v2rl/arty火炮/"
    "jeep/apc/e1步兵/e2掷弹兵/e3火箭兵/e4火焰兵/dog狗/shok电兵/e7谭雅/"
    "mig米格/yak雅克/hind雌鹿/heli阿帕奇> | air=true (空军/所有飞机) | "
